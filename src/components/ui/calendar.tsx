  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn(
          "rounded-xl border border-border/60 bg-muted/70 text-foreground data-[selected=true]:rounded-none",
