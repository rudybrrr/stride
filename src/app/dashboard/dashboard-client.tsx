...
const DARK_COLORS = ["#f8fafc", "#bae6fd", "#fecdd3", "#99f6e4", "#fef08a", "#e9d5ff"];
const LIGHT_COLORS = ["hsl(var(--primary))", "#e11d48", "#059669", "#2563eb", "#d97706", "#7c3aed"];
...
export default function DashboardClient({ userId }: { userId: string }) {
    const { lists, profile, stats, loading } = useData();
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        {[
                            ...
                            },
                            {
                                ...
                                subtext: parseInt(stats.avgSession, 10) > 0 ? "Highly productive" : "Start your first session",
                                icon: Timer,
                                color: "text-blue-500",
                            },
                        ].map((stat, i) => (
                                                    ...
                                                    >
                                                        {stats.subjectData.map((entry, index) => (
                                                            <Cell
                                                                ...
                                                                stroke={isDark ? "#ffffff" : "transparent"}
                                                                strokeOpacity={0.5}
                                                                strokeWidth={3}
                                                            />
                                                        ))}
...
const StatsCard = React.memo(function StatsCard({ title, value, subtext, icon: Icon, color }: StatsCardProps) {
    return (
