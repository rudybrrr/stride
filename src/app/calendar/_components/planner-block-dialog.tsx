...
export function PlannerBlockDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-xl rounded-[1.75rem] border border-[color:var(--surface-glass-border)] bg-[var(--surface-glass)] p-0 shadow-[var(--shadow-raised)] backdrop-blur-xl">
        <DialogHeader className="border-b border-border/60 bg-background/82 px-5 py-4">
        ...
        <div className="space-y-4 px-5 py-5">
          <div className="space-y-2">
            ...
            <Input
              ...
              className="border-border/60 bg-background/82"
            />
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Select value={form.listId} onValueChange={(value) => onSetForm((current) => ({ ...current, listId: value }))}>
                <SelectTrigger id="blockProject" className="border-border/60 bg-background/82">
            ...
            <div className="space-y-2">
              ...
              >
                <SelectTrigger id="blockTask" className="border-border/60 bg-background/82">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="space-y-2">
              ...
              <DatePickerField id="blockDate" value={form.date} onChange={(value) => onSetForm((current) => ({ ...current, date: value }))} className="border-border/60 bg-background/82" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <TimeSelectField id="blockStart" value={form.startTime} onChange={(value) => onSetForm((current) => ({ ...current, startTime: value }))} className="border-border/60 bg-background/82" />
            </div>
          ...
          <div className="surface-muted flex items-center justify-between rounded-xl px-4 py-4 text-sm text-muted-foreground">
        ...
        <DialogFooter className="justify-between border-t border-border/60 px-5 py-4 sm:justify-between">
          {form.id ? (
            <Button variant="ghost" className="rounded-full text-destructive hover:text-destructive" onClick={onDelete}>
              Delete
            </Button>
          ) : <div />}
          <div className="flex gap-2">
            {form.id && onStartFocus ? (
              <Button variant="outline" className="rounded-full" onClick={onStartFocus}>
                Start focus
              </Button>
            ) : null}
            ...
            <Button className="rounded-full" onClick={onSave} disabled={saving || !form.title.trim() || !form.listId}>
