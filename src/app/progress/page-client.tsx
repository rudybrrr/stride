                ...
                <div className="space-y-5">
                    ...
                    <div className="grid gap-5 xl:grid-cols-[minmax(0,1.12fr)_minmax(0,0.88fr)]">
                        <div className="space-y-5">
                            <SectionCard
                                title="Slipped tasks"
                                description="Open work due by today or already overdue."
                            >
                                            ...
                                            >
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    <div className="flex items-start justify-between gap-3">
                                                        ...
                                                        <Badge variant={getSlippedTaskVariant(task)} className="shrink-0">
                                            ...
                                            >
                                                <div className="flex items-start justify-between gap-3">
                                                    <div className="min-w-0">
                                                        <p className="truncate text-sm font-medium text-foreground">{project.listName}</p>
                                                        <p className="mt-1 text-xs leading-5 text-muted-foreground">
                                                            {project.openCount} open | {project.overdueCount} overdue | {project.underplannedCount} underplanned
                                                        </p>
                                                    </div>
                                                    <Badge variant={project.overdueCount > 0 ? "danger" : "warning"} className="shrink-0">
                        ...
                        <div className="space-y-5">
                            ...
                            <SectionCard
                                ...
                                description="Where the week's focus landed."
                            >
                        ...
                        <div className="grid gap-3 md:grid-cols-3">
                            ...
                            <div className="rounded-[1.05rem] bg-background/60 p-4">
                                ...
                                <p className="mt-1 text-sm text-muted-foreground">
                                    {measuredTaskCount > 0 ? "Estimated tasks landing near the plan." : "No estimated completions this week."}
                                </p>
                            </div>
                        </div>
                    </SectionCard>
